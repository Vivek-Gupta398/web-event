let base_url = "handler.php";
        ...
        var t = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
            ...
            var y= document.getElementById("registraton");
            var z= document.getElementById("show_list");
        ...
        {   
            ...
            c=document.getElementById("mobileNo").value;
            d=document.getElementById("emailId").value;
            f=document.getElementById("no_of_tickets").value;
            g=document.getElementById("optradio").value;
            e=document.getElementById("budget").checked;
